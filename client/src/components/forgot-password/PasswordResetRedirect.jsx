  ...
  useEffect(() => {
    const handleRedirect = async () => {
      ...
      if (tabCommunication.hasPasswordResetTab()) {
        // Tạo URL confirm đầy đủ
        const confirmUrl = `/auth/confirm-password-reset?token=${verificationId}&email=${encodeURIComponent(email)}`;
    ...
    return (
      <div className="flex min-h-screen items-center justify-center bg-gray-100">
        <div className="text-center">
          ...
          <p className="text-gray-600">Đang kiểm tra và chuyển hướng bạn đến trang xác nhận.</p>
        </div>
      </div>
    );
  }
      ...
      <div className="flex min-h-screen items-center justify-center bg-gray-100">
        <div className="text-center max-w-md mx-auto p-6">
          ...
          <p className="text-gray-600 mb-4">
            Đã chuyển bạn về tab gốc để xác nhận thay đổi mật khẩu. 
